<template>
  <div>
    ...
    >
      <path
        style="fill:#F2F2F2;"
        d="M384.454,0H22.919C11.425,0,2.021,9.404,2.021,20.898v459.755c0,11.494,9.404,20.898,20.898,20.898
	h361.535c11.494,0,20.898-9.404,20.898-20.898V20.898C405.352,9.404,395.948,0,384.454,0z"
      ...
      <polygon
        style="fill:#FFD15C;"
        points="354.152,341.682 291.458,404.376 207.866,421.094 153.531,431.543 163.98,377.208 
	180.699,293.616 243.393,231.967 "
      ...
      <g>
        ...
        <path
          style="fill:#40596B;"
          d="M493.123,172.408l-80.457-80.457c-8.359-8.359-20.898-8.359-29.257,0l-25.078,25.078
